    ...
    <div className="signup-container">
      <div className="signup-box">
        ...
        <div>
          ...
          <input type="text" className="sCode" placeholder="Enter Security Code Here" value={formData.securityCode} onChange={handleSecurityCodeChange} />
          <button type="button" onClick={handleVerifySecurityCode}>Verify Security Code</button>
          {securityCodeVerified && <p style={{ color: "green" }}>Security code verified!</p>}
        </div>
